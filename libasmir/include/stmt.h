...
public:
    ...
    VarDecl(string name, reg_t typ, address_t asm_ad = 0x0, address_t ir_ad = 0x0);
    VarDecl(Temp *t);
...
public:
    ...
    CJmp(Exp *c, Exp *t, Exp *f, address_t asm_ad = 0x0, address_t ir_ad = 0x0);
...
public:
    ...
    Return(Exp *exp_opt, address_t asm_ad = 0x0, address_t ir_ad = 0x0);

...
enum binop_type_t
{
    ...
    LROTATE, RROTATE, LOGICAND, LOGICOR, BITAND, BITOR, XOR, EQ,
    NEQ, GT, LT, GE, LE, SDIVIDE, SMOD
};
...
public:
    ...
    // The original name for these phi variables.
    string phi_name; 
};
...
public:
    ...
    virtual string tostring() const
    {
        return "unknown \"" + str + "\" : " + Exp::string_type(typ);
    };
